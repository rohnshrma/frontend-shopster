              ...
              <div className="card shadow-sm border-0 rounded-4 h-100">
                <div className="card-body p-4">
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-7">{new Date(order.createdAt).toLocaleDateString()}</div>
                  </div>
                  ...
                  <button className="btn btn-primary w-100" onClick={updateStatus} disabled={status === order.status}>
                    Update Status
                  </button>
                </div>
              </div>
